          ...
          <ul className="flex border border-gray-100 rounded-lg bg-gray-50 items-center">
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white p-3 block"
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white p-3"
                    : "block text-gray-700 rounded hover:bg-gray-100 p-3"
                }
              >
                Store
