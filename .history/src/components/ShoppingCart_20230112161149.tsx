...
export function ShoppingCart({ isOpen }: ShoppingCartProps) {
  ...
  return (
    ...
    >
      <div
        className={
          " w-screen max-w-xs md:max-w-lg right-0 absolute bg-white h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform p-4" +
      ...
      >
        <article className="relative w-screen max-w-xs md:max-w-lg pb-10 flex flex-col space-y-6 overflow-y-scroll h-full">
          <div className="flex justify-between">
            <header className="font-bold text-lg">Cart</header>
            <span>
              <BsXLg
                onClick={closeCart}
